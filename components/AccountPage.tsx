    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 mb-16 md:mb-24">
        ...
        <button
          ...
          className="flex items-center gap-3 px-8 py-5 bg-black border-4 border-black shadow-[8px_8px_0_0_#004f57] font-black text-white text-xl uppercase tracking-widest hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0_0_#004f57] transition-all"
        >
          <CreditCard className="w-6 h-6 text-[#004f57]" />
          Credits Kopen
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16 md:mb-24">
        <div className="p-8 bg-black text-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <Zap className="w-8 h-8 mb-2 text-[#004f57]" />
        ...
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <MessageSquare className="w-8 h-8 mb-2 text-[#004f57]" />
        ...
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <History className="w-8 h-8 mb-2 text-[#004f57]" />
        ...
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <Users className="w-8 h-8 mb-2 text-[#004f57]" />
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className={`px-10 py-6 border-4 border-black font-black uppercase tracking-widest text-xl transition-all ${
                config.modelCount === 3 
                ? 'bg-[#004f57] text-black shadow-none' 
                : 'bg-white text-black hover:bg-[#004f57]/10'
              }`}
            >
              3 Nodes
            </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between border-b-4 border-black pb-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-black text-white font-black text-sm uppercase tracking-widest hover:bg-[#004f57] transition-all"
                >
            ...
            {/* Add Node Form */}
            {isAddingNode && (
              <div className="p-6 bg-white border-4 border-black space-y-4 animate-in slide-in-from-top-2 duration-300 shadow-[10px_10px_0_0_#004f57]">
                    ...
                    <div key={node.id} className={`p-4 bg-white border-2 border-black flex items-center justify-between group shadow-[2px_2px_0_0_black] hover:border-black hover:shadow-[4px_4px_0_0_black] transition-all ${isActive ? 'border-black shadow-[4px_4px_0_0_black]' : ''}`}>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 font-black text-base uppercase tracking-widest border transition-all ${isActive ? 'bg-[#004f57] border-[#004f57] text-black' : 'bg-white border-black/20 text-black hover:border-[#004f57] hover:text-[#004f57]'}`}
                        >
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              <button
                ...
                className="flex items-center justify-center gap-6 p-10 bg-white border-4 border-black hover:bg-[#004f57] hover:text-black transition-all group shadow-[10px_10px_0_0_black] hover:shadow-none translate-x-1 translate-y-1"
              >
        ...
        <div className="space-y-10">
          <div className="flex items-center justify-between border-b-8 border-black pb-8 text-black">
            ...
            <div className="flex items-center gap-4">
              {selectedIds.length > 0 && (
                <div className="flex items-center gap-3 animate-in fade-in duration-300">
                  <button
                    ...
                    className="p-3 bg-zinc-100 border-2 border-black hover:bg-[#004f57] transition-colors"
              ...
              <span className="px-6 py-2 bg-black text-white text-xl font-black rounded-none uppercase tracking-widest border-4 border-black shadow-[4px_4px_0_0_#004f57]">
          ...
          <div className="space-y-6">
            {activeHistory.length > 0 && (
              <div className="flex items-center justify-between px-2 pb-4">
                <button
                  ...
                  className="flex items-center gap-3 text-lg font-black uppercase tracking-widest text-[#004f57] hover:text-black transition-colors"
                >
            ...
            {activeHistory.length === 0 ? (
              <div className="py-16 text-center bg-white border-4 border-dashed border-[#004f57] rounded-none shadow-[10px_10px_0_0_#004f57]">
                <Database className="w-12 h-12 text-[#004f57] mx-auto mb-4" />
                <p className="font-black uppercase tracking-widest text-[#004f57] text-xl mb-2">Lokale Kluis Leeg</p>
                ...
                <button
                  ...
                  className="mt-6 px-10 py-5 bg-black text-white border-4 border-black font-black text-lg uppercase tracking-widest hover:bg-[#004f57] hover:text-black transition-all shadow-[6px_6px_0_0_#004f57]"
                >
              ...
              currentHistory.map((session) => (
                <div key={session.id} className="relative group/row pl-12 mb-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between p-8 bg-white border-4 border-black shadow-[10px_10px_0_0_black] hover:border-[#004f57] hover:shadow-[10px_10px_0_0_#004f57] hover:-translate-x-1 hover:-translate-y-1 transition-all"
                  >
                    <div className="flex items-center gap-6 overflow-hidden">
                      <div className="p-4 bg-zinc-100 rounded-none flex-shrink-0 border-2 border-black">
                        <MessageSquare className="w-8 h-8 text-[#004f57]" />
                      </div>
                    ...
                    <ChevronRight className="w-8 h-8 flex-shrink-0 opacity-0 group-hover/row:opacity-100 transition-all text-[#004f57]" />
                  </button>
                </div>
              ))
            )}
