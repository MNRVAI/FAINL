    ...
    <div className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10 mb-16 md:mb-24">
        <div>
          ...
          <p className="text-black/70 font-bold text-xl md:text-3xl leading-tight">
            Beheer je credits, nodes, datakluis en je gestelde vragen.
          </p>
        </div>
        <button
          onClick={() => navigate('/tokens')}
          className="flex items-center gap-3 px-8 py-5 bg-black border-4 border-black shadow-[8px_8px_0_0_#03B390] font-black text-white text-xl uppercase tracking-widest hover:translate-x-[-4px] hover:translate-y-[-4px] hover:shadow-[12px_12px_0_0_#03B390] transition-all"
        >
          <CreditCard className="w-6 h-6 text-[#03B390]" />
          Credits Kopen
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16 md:mb-24">
        <div className="p-8 bg-black text-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <Zap className="w-8 h-8 mb-2 text-[#03B390]" />
        ...
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <MessageSquare className="w-8 h-8 mb-2 text-[#03B390]" />
          <div className="text-6xl font-black text-black">{freeSessiesResterend}</div>
          <div className="text-xl font-black uppercase tracking-[0.2em] text-black/50">Gratis</div>
        </div>
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <History className="w-8 h-8 mb-2 text-[#03B390]" />
          <div className="text-6xl font-black text-black">{totalSessies}</div>
          <div className="text-xl font-black uppercase tracking-[0.2em] text-black/50">Sessies</div>
        </div>
        <div className="p-8 bg-white border-4 border-black shadow-[8px_8px_0_0_black] hover:scale-105 transition-all flex flex-col gap-2">
          <Users className="w-8 h-8 mb-2 text-[#03B390]" />
          <div className="text-6xl font-black text-black">{config.activeCouncil.length}</div>
          <div className="text-xl font-black uppercase tracking-[0.2em] text-black/50">Nodes</div>
        </div>
      </div>
      ...
      <div className="mb-16 md:mb-24 p-10 md:p-16 bg-white border-4 border-black shadow-[12px_12px_0_0_black]">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="text-center md:text-left">
            ...
            <p className="text-xl font-bold text-black/50 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              className={`px-10 py-6 border-4 border-black font-black uppercase tracking-widest text-xl transition-all ${
                config.modelCount === 3 
                ? 'bg-[#03B390] text-black shadow-none' 
                : 'bg-white text-black hover:bg-[#03B390]/10'
              }`}
            >
              3 Nodes
            </button>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              <button
                ...
                className="flex items-center justify-center gap-6 p-10 bg-white border-4 border-black hover:bg-[#03B390] hover:text-black transition-all group shadow-[10px_10px_0_0_black] hover:shadow-none translate-x-1 translate-y-1"
              >
        ...
        <div className="space-y-10">
          <div className="flex items-center justify-between border-b-8 border-black pb-8 text-black">
            ...
            <div className="flex items-center gap-4">
              {selectedIds.length > 0 && (
                <div className="flex items-center gap-3 animate-in fade-in duration-300">
                  <button
                    ...
                    className="p-3 bg-zinc-100 border-2 border-black hover:bg-[#03B390] transition-colors"
              ...
              <span className="px-6 py-2 bg-black text-white text-xl font-black rounded-none uppercase tracking-widest border-4 border-black shadow-[4px_4px_0_0_#03B390]">
          ...
          <div className="space-y-6">
            {activeHistory.length > 0 && (
              <div className="flex items-center justify-between px-2 pb-4">
                <button
                  ...
                  className="flex items-center gap-3 text-lg font-black uppercase tracking-widest text-[#03B390] hover:text-black transition-colors"
                >
                ...
                {totalPages > 1 && (
                  <div className="flex items-center gap-6">
                    ...
                    <span className="text-lg font-black uppercase tracking-widest text-black/40">{currentPage} / {totalPages}</span>
                    <button
            ...
            {activeHistory.length === 0 ? (
              <div className="py-16 text-center bg-white border-4 border-dashed border-[#03B390] rounded-none shadow-[10px_10px_0_0_#03B390]">
                <Database className="w-12 h-12 text-[#03B390] mx-auto mb-4" />
                <p className="font-black uppercase tracking-widest text-[#03B390] text-xl mb-2">Lokale Kluis Leeg</p>
                <p className="text-lg font-bold text-black/40 uppercase tracking-widest text-center px-6">Hier kun je al jouw gestelde vragen inzien en teruglezen.</p>
                <button
                  onClick={() => navigate('/mission')}
                  className="mt-6 px-10 py-5 bg-black text-white border-4 border-black font-black text-lg uppercase tracking-widest hover:bg-[#03B390] hover:text-black transition-all shadow-[6px_6px_0_0_#03B390]"
                >
              ...
              currentHistory.map((session) => (
                <div key={session.id} className="relative group/row pl-12 mb-6">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-between p-8 bg-white border-4 border-black shadow-[10px_10px_0_0_black] hover:border-[#03B390] hover:shadow-[10px_10px_0_0_#03B390] hover:-translate-x-1 hover:-translate-y-1 transition-all"
                  >
                    <div className="flex items-center gap-6 overflow-hidden">
                      <div className="p-4 bg-zinc-100 rounded-none flex-shrink-0 border-2 border-black">
                        <MessageSquare className="w-8 h-8 text-[#03B390]" />
                      </div>
                      <div className="text-left overflow-hidden">
                        ...
                        <span className="text-lg font-bold text-black/40 uppercase tracking-widest">
                          {formatDate(session.timestamp)}
                        </span>
                      </div>
                    </div>
                    <ChevronRight className="w-8 h-8 flex-shrink-0 opacity-0 group-hover/row:opacity-100 transition-all text-[#03B390]" />
                  </button>
                </div>
              ))
            )}
