    ...
    <div className="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-24 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="mb-20 md:mb-32">
        <div className="flex items-center gap-4 mb-8">
          <span className="px-4 py-2 bg-black dark:bg-[#03B390] text-white dark:text-black text-lg font-black uppercase tracking-widest rounded-none">
            {directive.category}
          </span>
          <span className="text-lg font-black text-[#03B390] dark:text-[#03B390] uppercase tracking-widest">
            ID: {directive.id}
          </span>
        </div>
        ...
        <p className="text-xl md:text-3xl font-bold text-black/70 dark:text-white/80 leading-relaxed italic border-l-8 border-[#03B390] pl-10 py-4">
      ...
      {/* Main Action Card */}
      <div className="bg-white dark:bg-black border-4 border-black dark:border-[#03B390] rounded-none p-10 md:p-20 shadow-[15px_15px_0_0_black] dark:shadow-[15px_15px_0_0_#03B390] mb-20 md:mb-32 relative overflow-hidden group">
        <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
          <Zap className="w-48 h-48 text-black dark:text-[#03B390]" />
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-16">
            <div className="flex flex-col gap-3">
              <div className="flex items-center gap-3 text-base font-black uppercase tracking-widest text-[#03B390] dark:text-[#03B390]">
          ...
          <button
            ...
            className="w-full md:w-auto px-12 py-6 bg-black dark:bg-[#03B390] text-white dark:text-black rounded-none font-black uppercase tracking-[0.2em] text-xl hover:bg-[#03B390] hover:text-black dark:hover:bg-white transition-all shadow-2xl flex items-center justify-center gap-4"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
        <div className="space-y-8">
          ...
          <p className="text-lg md:text-2xl text-black/70 dark:text-white/80 leading-relaxed font-bold">
